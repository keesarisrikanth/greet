...
class RandomWordsState extends State<RandomWords> {
  ...
  // Build Row that builds the row of ListView - ListTile
  Widget _buildRow(WordPair suggestion) {
    final bool _alreadySaved = _savedWords.contains(suggestion);
  ...
  // Push Saved method - On Tap of List button pushes to FavRoute
  void _pushSaved() {
    // Navigating to new route - pushing the new route to the navigator
